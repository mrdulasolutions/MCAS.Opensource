...
| [EXP-022](EXP-022-sensitivity-lhs-rerun.md) | Sensitivity LHS rerun over EXP-021 composite | 200-sample joint LHS over 6 macro-weights. **Curcumin maintenance #1 in 100% of samples** (was already 100%, now even tighter via PTGS2). **Erucin + Sulforaphane combined remission #1 in 100% of samples** (split shifted 91.5/8.5 → 60/40 — the two SFN compounds are interchangeable). Piceatannol entered top-10 stability set in 47% of samples (was nowhere before EXP-021). | published | 2026-05-27 |
| [EXP-023](EXP-023-keap1-btb-c151-docking.md) | KEAP1 BTB Cys-151 encounter docking fused with adduct energy | Vina on PDB 5DAD box@C151 SG + EXP-012 score_c151 → score_btb_covalent; integrated as KEAP1-axis +0.05 | published | 2026-07-27 |
| [EXP-024](EXP-024-expanded-benchmarks-self-debias.md) | Expanded recovery/control sets + self-similarity de-bias | known actives ≥50, negatives ≥100; Tanimoto self-match (≥0.99) excluded from target scores | published | 2026-07-27 |
| [EXP-025](EXP-025-novelty-filter-enamine-cards.md) | Generated-analog novelty filter + Enamine on rankings/UI | tanimoto_to_sfn_class, novelty_score, near-duplicate penalty, REAL-space flags on ranked CSVs + Space | published | 2026-07-27 |
